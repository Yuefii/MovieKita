...
export default async function Page({
  ...
  return (
    <div className="min-h-screen bg-[#141414] text-white">
      <Navbar />
      <div className="relative min-h-[70vh] w-full flex flex-col justify-end group">
        ...
        <div className="relative w-full p-4 md:p-12 flex flex-col md:flex-row gap-4 md:gap-8 items-start md:items-end z-10">
          ...
          <div className="space-y-4 max-w-4xl">
            <h1 className="text-2xl md:text-6xl font-bold drop-shadow-lg font-sans">
              {movie.title}
            </h1>
